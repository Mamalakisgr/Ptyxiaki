<template>
  <aside class="sticky top-20 h-[calc(100vh-6rem)] bg-white dark:bg-gray-800 shadow-xl rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden mx-4">
